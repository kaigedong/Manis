use super::{
    Context, ControllerRuntime, ControllerState, KernelKind, KernelRuntime, KernelSwitchFailure,
    KernelSwitchState, LiveStreamPhase, LiveStreamStatus, LoadedSnapshot, LogLevel,
    ManagedPolicyRuntimeState, ManisApp, MihomoCoreUpdateOutcome, MihomoCoreUpdateState, ProxyMode,
    ProxyPorts, UiEvent, apply_proxy_mode_transition, begin_operation, copy, core_update, kernel,
    mihomo, perform_kernel_switch, perform_mihomo_core_update, record_event, record_operation,
    trace_ui,
};

impl ManisApp {
    pub(in crate::app) fn switch_kernel(&mut self, requested: KernelKind, cx: &mut Context<Self>) {
