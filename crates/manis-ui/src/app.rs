...
pub struct ManisApp {
    ...
    direct_rules: Vec<crate::direct_rule::DirectRule>,
    direct_rule_input: Option<Entity<SubscriptionTextInput>>,
    direct_rule_error: Option<crate::direct_rule::DirectRuleError>,
...
impl ManisApp {
    ...
    fn with_runtime_and_store(
        ...
        Self {
            ...
            direct_rule_input: None,
            direct_rule_error: None,
        ...
        cx.spawn(async move |this, cx| {
            let result = executor
                .spawn({
                    ...
                    async move { runtime.select_node_group_node(&group_name, &node_name) }
                })
                .await;
            this.update(cx, |this, cx| {
    ...
    fn node_row(
        ...
        let provider = if item.kind == manis_core::PolicyCandidateKind::NodeGroup {
        ...
        let leading = if manually_selectable {
            ...
            div()
                ...
                .items_center()
                .justify_center()
                .child(if item.kind == manis_core::PolicyCandidateKind::NodeGroup {
                    language.text("G", "组")
                } else {
                    language.text("N", "点")
                })
