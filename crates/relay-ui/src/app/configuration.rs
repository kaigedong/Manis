...
impl RelayApp {
    ...
    fn kernel_panel(&self, theme: Theme, compact: bool, cx: &mut Context<Self>) -> Stateful<Div> {
        ...
        let sing_box_reason = if !sing_box_installed {
            ...
            language.text(
                "Clash subscriptions are present; Relay needs its native parser first",
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .text_color(theme.text_secondary)
                                    .child(language.text(
                                        "Relay compiles and validates the target config before switching; failures keep the current kernel.",
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .text_color(theme.text_secondary)
                    .child(language.text(
                        "An isolated Mihomo process is parsing nodes; Relay only saves after success.",
