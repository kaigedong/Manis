...
pub(crate) enum UiEvent {
    ...
    SourcePreviewStarted,
    SourcePreviewSucceeded,
    SourcePreviewFailed,
...
impl UiEvent {
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::SourcePreviewStarted => "configuration.source_preview.started",
            Self::SourcePreviewSucceeded => "configuration.source_preview.succeeded",
            Self::SourcePreviewFailed => "configuration.source_preview.failed",
